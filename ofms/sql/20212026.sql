...
(5, 'report_data_resource', '报表数据源管理表', NULL, NULL, 'RepDataResource', 'crud', 'com.ruoyi.report', 'report', 'resource', '报数据源管理', 'Pekin', '0', '/', '{"parentMenuId":2000}', 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01', '数据源管理表');
...
CREATE TABLE IF NOT EXISTS `gen_table_column` (
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb3 COMMENT='代码生成业务表字段';
...
VALUES
(40, '5', 'id', '序号', 'int(11)', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(41, '5', 'connName', '连接名称', 'varchar(100)', 'String', 'connname', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 2, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(42, '5', 'connType', '数据库类型', 'varchar(50)', 'String', 'conntype', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'select', 'conn_type', 3, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(43, '5', 'connDriverClass', '驱动包名', 'varchar(100)', 'String', 'conndriverclass', '0', '0', NULL, '1', '1', '1', NULL, 'EQ', 'input', '', 4, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(44, '5', 'connIp', 'IP地址', 'varchar(100)', 'String', 'connip', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(45, '5', 'connPort', '端口号', 'varchar(100)', 'String', 'connport', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(46, '5', 'connDbName', '数据库名', 'varchar(50)', 'String', 'conndbname', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 7, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(47, '5', 'connUserName', '用户名', 'varchar(20)', 'String', 'connusername', '0', '0', NULL, '1', '1', '1', '1', 'LIKE', 'input', '', 8, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(48, '5', 'connPassWord', '密码', 'varchar(50)', 'String', 'connpassword', '0', '0', NULL, '1', '1', '1', NULL, 'EQ', 'input', '', 9, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(49, '5', 'connProperty', '附加参数', 'varchar(100)', 'String', 'connproperty', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01'),
(50, '5', 'createDate', '创建日期', 'datetime', 'Date', 'createdate', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'datetime', '', 11, 'admin', '2021-10-25 13:54:55', '', '2021-10-25 13:56:01');
...
('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1635161490000, -1, 5, 'PAUSED', 'CRON', 1635161490000, 0, NULL, 2, _binary ''),
('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1635161490000, -1, 5, 'PAUSED', 'CRON', 1635161490000, 0, NULL, 2, _binary ''),
('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1635161500000, -1, 5, 'PAUSED', 'CRON', 1635161490000, 0, NULL, 2, _binary '');
...
('RuoyiScheduler', 'MS-MRMXZQIDIHVL1635161490090', 1635163398201, 15000);
...
CREATE TABLE IF NOT EXISTS `report_data_resource` (
    ...
    `connPort` varchar(100) DEFAULT NULL COMMENT '端口号',
    `connDbName` varchar(50) DEFAULT NULL COMMENT '数据库名',
...
INSERT INTO `report_data_resource` (`id`, `connName`, `connType`, `connDriverClass`, `connIp`, `connPort`, `connDbName`, `connUserName`, `connPassWord`, `connProperty`, `createDate`) VALUES
(1, 'Test01', 'Mysql', 'com.mysql.cj.jdbc.Driver', '192.168.56.11', '3306', 'test', 'root', '123', 'serverTimezone=UTC', '2021-10-13 00:00:00');
...
CREATE TABLE IF NOT EXISTS `sys_logininfor` (
    ...
    PRIMARY KEY (`info_id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8mb3 COMMENT='系统访问记录';
...
(51, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-21 19:10:28'),
(52, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2021-10-21 19:37:50'),
(53, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-21 19:37:52'),
(54, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-21 21:25:35'),
(55, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-21 22:40:06'),
(56, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-22 10:40:30'),
(57, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-22 14:03:54'),
(58, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2021-10-22 14:28:00'),
(59, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-22 14:28:02'),
(60, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '退出成功', '2021-10-22 14:32:30'),
(61, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-22 14:32:35'),
(62, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-22 15:14:42'),
(63, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 10:45:18'),
(64, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 11:31:24'),
(65, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 12:55:56'),
(66, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 13:40:38'),
(67, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 14:45:31'),
(68, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 15:52:50'),
(69, 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-10-25 18:25:20');
...
CREATE TABLE IF NOT EXISTS `sys_menu` (
    ...
    PRIMARY KEY (`menu_id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=2063 DEFAULT CHARSET=utf8mb3 COMMENT='菜单权限表';
...
(2036, 'SQL编辑器', 2000, 3, 'design', 'report/resource/design', NULL, 1, 0, 'C', '0', '0', '', 'code', 'admin', '2021-10-20 09:45:00', 'admin', '2021-10-25 13:49:05', ''),
(2039, '小工具', 3, 4, 'kits', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'button', 'admin', '2021-10-22 14:36:24', '', NULL, ''),
(2040, '条码', 2039, 1, 'tiaoma', 'tool/kits/tiaoma', NULL, 1, 0, 'C', '0', '0', NULL, 'chart', 'admin', '2021-10-22 14:37:01', '', NULL, ''),
(2041, 'Json可视化', 2039, 2, 'jsoner', 'tool/kits/jsoner', NULL, 1, 0, 'C', '0', '0', '', 'component', 'admin', '2021-10-22 15:15:56', 'admin', '2021-10-22 15:16:35', ''),
(2042, 'json编辑器', 2039, 3, 'jsonedit', 'tool/kits/jsonedit', NULL, 1, 0, 'C', '0', '0', NULL, 'cascader', 'admin', '2021-10-22 15:22:46', '', NULL, ''),
(2043, 'json校验', 2039, 4, 'jsonpretty', 'tool/kits/jsonpretty', NULL, 1, 0, 'C', '0', '0', NULL, 'button', 'admin', '2021-10-22 15:34:23', '', NULL, ''),
(2044, 'json视图', 2039, 5, 'jsonview', 'tool/kits/jsonview', NULL, 1, 0, 'C', '0', '0', NULL, 'code', 'admin', '2021-10-22 16:06:07', '', NULL, ''),
(2057, '报数据源管理', 2000, 2, 'resource', 'report/resource/index', NULL, 1, 0, 'C', '0', '0', 'report:resource:list', 'data-source', 'admin', '2021-10-25 13:56:33', 'admin', '2021-10-25 14:07:49', '报数据源管理菜单'),
(2058, '报数据源管理查询', 2057, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'report:resource:query', '#', 'admin', '2021-10-25 13:56:33', '', NULL, ''),
(2059, '报数据源管理新增', 2057, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'report:resource:add', '#', 'admin', '2021-10-25 13:56:33', '', NULL, ''),
(2060, '报数据源管理修改', 2057, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'report:resource:edit', '#', 'admin', '2021-10-25 13:56:33', '', NULL, ''),
(2061, '报数据源管理删除', 2057, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'report:resource:remove', '#', 'admin', '2021-10-25 13:56:33', '', NULL, ''),
(2062, '报数据源管理导出', 2057, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'report:resource:export', '#', 'admin', '2021-10-25 13:56:33', '', NULL, '');
...
CREATE TABLE IF NOT EXISTS `sys_oper_log` (
    ...
    PRIMARY KEY (`oper_id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=166 DEFAULT CHARSET=utf8mb3 COMMENT='操作日志记录';
...
(117, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"guide","orderNum":"7","menuName":"小工具箱","params":{},"parentId":0,"isCache":"0","path":"tools","createBy":"admin","children":[],"isFrame":"1","menuType":"M","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:10:45'),
(118, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"guide","orderNum":"7","menuName":"小工具箱","params":{},"parentId":0,"isCache":"0","path":"kits","children":[],"createTime":1634883045000,"updateBy":"admin","isFrame":"1","menuId":2037,"menuType":"M","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:12:11'),
(119, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"barcode","component":"kits/barcode","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:13:53'),
(120, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"barcode","component":"kits/barcode","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:19:36'),
(121, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"barcode","component":"kits/barcode/barcode","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:23:56'),
(122, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"barcode","component":"kits/barcode/barcode","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:25:47'),
(123, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"tiaoma","component":"kits/barcode/barcode","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:27:26'),
(124, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"guide","orderNum":"7","menuName":"小工具箱","params":{},"parentId":0,"isCache":"0","path":"kits","children":[],"createTime":1634883045000,"updateBy":"admin","isFrame":"1","menuId":2037,"menuType":"M","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:27:32'),
(125, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"tiaoma","component":"kits/barcode/tiaoma","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:28:39'),
(126, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"guide","orderNum":"7","menuName":"小工具箱","params":{},"parentId":0,"isCache":"0","path":"mykits","children":[],"createTime":1634883045000,"updateBy":"admin","isFrame":"1","menuId":2037,"menuType":"M","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:31:41'),
(127, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"tiaoma","component":"mykits/barcode/tiaoma","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:31:48'),
(128, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"guide","orderNum":"7","menuName":"小工具箱","params":{},"parentId":0,"isCache":"0","path":"mykits","children":[],"createTime":1634883045000,"updateBy":"admin","isFrame":"1","menuId":2037,"menuType":"M","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:32:49'),
(129, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"icon","orderNum":"1","menuName":"条码","params":{},"parentId":2037,"isCache":"0","path":"tiaoma","component":"mykits/tiaoma","children":[],"createTime":1634883233000,"updateBy":"admin","isFrame":"1","menuId":2038,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:33:08'),
(130, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2038', '127.0.0.1', '内网IP', '{menuId=2038}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:35:35'),
(131, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2037', '127.0.0.1', '内网IP', '{menuId=2037}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:35:38'),
(132, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"button","orderNum":"4","menuName":"小工具","params":{},"parentId":3,"isCache":"0","path":"kits","createBy":"admin","children":[],"isFrame":"1","menuType":"M","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:36:24'),
(133, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"chart","orderNum":"1","menuName":"条码","params":{},"parentId":2039,"isCache":"0","path":"tiaoma","component":"tool/kits/tiaoma","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 14:37:01'),
(134, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"component","orderNum":"2","menuName":"Json可视化","params":{},"parentId":2039,"isCache":"0","path":"jsoner","component":"tool/jsoner/index","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 15:15:56'),
(135, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"component","orderNum":"2","menuName":"Json可视化","params":{},"parentId":2039,"isCache":"0","path":"jsoner","component":"tool/kits/jsoner","children":[],"createTime":1634886956000,"updateBy":"admin","isFrame":"1","menuId":2041,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 15:16:35'),
(136, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"cascader","orderNum":"3","menuName":"json编辑器","params":{},"parentId":2039,"isCache":"0","path":"jsonedit","component":"tool/kits/jsonedit","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 15:22:46'),
(137, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"button","orderNum":"4","menuName":"json校验","params":{},"parentId":2039,"isCache":"0","path":"jsonpretty","component":"tool/kits/jsonpretty","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 15:34:23'),
(138, '菜单管理', 1, 'com.ruoyi.web.controller.system.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"code","orderNum":"5","menuName":"json视图","params":{},"parentId":2039,"isCache":"0","path":"jsonview","component":"tool/kits/jsonview","createBy":"admin","children":[],"isFrame":"1","menuType":"C","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-22 16:06:07'),
(139, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2007', '127.0.0.1', '内网IP', '{menuId=2007}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:50:53'),
(140, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2006', '127.0.0.1', '内网IP', '{menuId=2006}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:50:56'),
(141, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2005', '127.0.0.1', '内网IP', '{menuId=2005}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:50:59'),
(142, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2004', '127.0.0.1', '内网IP', '{menuId=2004}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:02'),
(143, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2003', '127.0.0.1', '内网IP', '{menuId=2003}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:04'),
(144, '菜单管理', 3, 'com.ruoyi.web.controller.system.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/system/menu/2002', '127.0.0.1', '内网IP', '{menuId=2002}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:09'),
(145, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"code","orderNum":"2","menuName":"SQL编辑器","params":{},"parentId":2000,"isCache":"0","path":"design","component":"report/resource/design","children":[],"createTime":1634694300000,"updateBy":"admin","isFrame":"1","menuId":2036,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:24'),
(146, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/2,1', '127.0.0.1', '内网IP', '{tableIds=2,1}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:38'),
(147, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'report_data_resource', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:51:44'),
(148, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{"sub":false,"functionAuthor":"Pekin","columns":[{"capJavaField":"Id","usableColumn":false,"columnId":21,"isIncrement":"1","increment":true,"insert":true,"dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"id","htmlType":"input","edit":false,"query":false,"columnComment":"序号","sort":1,"list":false,"params":{},"javaType":"Long","queryType":"EQ","columnType":"int(11)","createBy":"admin","isPk":"1","createTime":1635133904000,"tableId":3,"pk":true,"columnName":"id"},{"capJavaField":"Connname","usableColumn":false,"columnId":22,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"connname","htmlType":"input","edit":true,"query":true,"columnComment":"连接名称","isQuery":"1","sort":2,"list":true,"params":{},"javaType":"String","queryType":"LIKE","columnType":"varchar(100)","createBy":"admin","isPk":"0","createTime":1635133904000,"isEdit":"1","tableId":3,"pk":false,"columnName":"connName"},{"capJavaField":"Conntype","usableColumn":false,"columnId":23,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"conn_type","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conntype","htmlType":"select","edit":true,"query":true,"columnComment":"数据库类型","isQuery":"1","sort":3,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(50)","createBy":"admin","isPk":"0","createTime":1635133904000,"isEdit":"1","tableId":3,"pk":false,"columnName":"connType"},{"capJavaField":"Conndriverclass","usableColumn":false,"columnId":24,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conndriverclass","htmlType":"input","edit":true,"query":true,"columnComment":"驱动包名","isQuery":"1","sort":4,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(100)","createBy', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 11:54:18'),
(149, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', NULL, 0, NULL, '2021-10-25 11:54:38'),
(150, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"chart","orderNum":"1","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635134128000,"updateBy":"admin","isFrame":"1","menuId":2045,"menuType":"C","perms":"resource:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:06:09'),
(151, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"data-source","orderNum":"1","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635134128000,"updateBy":"admin","isFrame":"1","menuId":2045,"menuType":"C","perms":"resource:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:06:32'),
(152, '报数据源管理', 3, 'com.ruoyi.report.controller.RepDataResourceController.remove()', 'DELETE', 1, 'admin', NULL, '/resource/resource/2', '127.0.0.1', '内网IP', '{ids=2}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:06:52'),
(153, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/3', '127.0.0.1', '内网IP', '{tableIds=3}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:40:56'),
(154, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'report_data_resource', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:41:02'),
(155, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{"sub":false,"functionAuthor":"Pekin","columns":[{"capJavaField":"Id","usableColumn":false,"columnId":30,"isIncrement":"1","increment":true,"insert":true,"dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"id","htmlType":"input","edit":false,"query":false,"columnComment":"序号","sort":1,"list":false,"params":{},"javaType":"Long","queryType":"EQ","columnType":"int(11)","createBy":"admin","isPk":"1","createTime":1635140462000,"tableId":4,"pk":true,"columnName":"id"},{"capJavaField":"Connname","usableColumn":false,"columnId":31,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"connname","htmlType":"input","edit":true,"query":true,"columnComment":"连接名称","isQuery":"1","sort":2,"list":true,"params":{},"javaType":"String","queryType":"LIKE","columnType":"varchar(100)","createBy":"admin","isPk":"0","createTime":1635140462000,"isEdit":"1","tableId":4,"pk":false,"columnName":"connName"},{"capJavaField":"Conntype","usableColumn":false,"columnId":32,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"conn_type","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conntype","htmlType":"select","edit":true,"query":true,"columnComment":"数据库类型","isQuery":"1","sort":3,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(50)","createBy":"admin","isPk":"0","createTime":1635140462000,"isEdit":"1","tableId":4,"pk":false,"columnName":"connType"},{"capJavaField":"Conndriverclass","usableColumn":false,"columnId":33,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conndriverclass","htmlType":"input","edit":true,"query":false,"columnComment":"驱动包名","sort":4,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(100)","createBy":"admin","is', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:42:37'),
(156, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', NULL, 0, NULL, '2021-10-25 13:42:40'),
(157, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"code","orderNum":"3","menuName":"SQL编辑器","params":{},"parentId":2000,"isCache":"0","path":"design","component":"report/resource/design","children":[],"createTime":1634694300000,"updateBy":"admin","isFrame":"1","menuId":2036,"menuType":"C","perms":"","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:49:05'),
(158, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"#","orderNum":"2","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635140619000,"updateBy":"admin","isFrame":"1","menuId":2051,"menuType":"C","perms":"report:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:49:16'),
(159, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"data-source","orderNum":"2","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635140619000,"updateBy":"admin","isFrame":"1","menuId":2051,"menuType":"C","perms":"report:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:49:35'),
(160, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/4', '127.0.0.1', '内网IP', '{tableIds=4}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:54:50'),
(161, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'report_data_resource', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:54:55'),
(162, '代码生成', 2, 'com.ruoyi.generator.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/tool/gen', '127.0.0.1', '内网IP', '{"sub":false,"functionAuthor":"Pekin","columns":[{"capJavaField":"Id","usableColumn":false,"columnId":40,"isIncrement":"1","increment":true,"insert":true,"dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"id","htmlType":"input","edit":false,"query":false,"columnComment":"序号","sort":1,"list":false,"params":{},"javaType":"Long","queryType":"EQ","columnType":"int(11)","createBy":"admin","isPk":"1","createTime":1635141295000,"tableId":5,"pk":true,"columnName":"id"},{"capJavaField":"Connname","usableColumn":false,"columnId":41,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"connname","htmlType":"input","edit":true,"query":true,"columnComment":"连接名称","isQuery":"1","sort":2,"list":true,"params":{},"javaType":"String","queryType":"LIKE","columnType":"varchar(100)","createBy":"admin","isPk":"0","createTime":1635141295000,"isEdit":"1","tableId":5,"pk":false,"columnName":"connName"},{"capJavaField":"Conntype","usableColumn":false,"columnId":42,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"conn_type","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conntype","htmlType":"select","edit":true,"query":true,"columnComment":"数据库类型","isQuery":"1","sort":3,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(50)","createBy":"admin","isPk":"0","createTime":1635141295000,"isEdit":"1","tableId":5,"pk":false,"columnName":"connType"},{"capJavaField":"Conndriverclass","usableColumn":false,"columnId":43,"isIncrement":"0","increment":false,"insert":true,"isList":"1","dictType":"","required":false,"superColumn":false,"updateBy":"","isInsert":"1","javaField":"conndriverclass","htmlType":"input","edit":true,"query":false,"columnComment":"驱动包名","sort":4,"list":true,"params":{},"javaType":"String","queryType":"EQ","columnType":"varchar(100)","createBy":"admin","is', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 13:56:01'),
(163, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', NULL, 0, NULL, '2021-10-25 13:56:04'),
(164, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"#","orderNum":"2","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635141393000,"updateBy":"admin","isFrame":"1","menuId":2057,"menuType":"C","perms":"report:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 14:07:41'),
(165, '菜单管理', 2, 'com.ruoyi.web.controller.system.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/system/menu', '127.0.0.1', '内网IP', '{"visible":"0","icon":"data-source","orderNum":"2","menuName":"报数据源管理","params":{},"parentId":2000,"isCache":"0","path":"resource","component":"report/resource/index","children":[],"createTime":1635141393000,"updateBy":"admin","isFrame":"1","menuId":2057,"menuType":"C","perms":"report:resource:list","status":"0"}', '{"msg":"操作成功","code":200}', 0, NULL, '2021-10-25 14:07:49');
...
(1, 103, 'admin', '手里没有王', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2021-10-25 18:25:20', 'admin', '2021-10-13 00:01:45', '', '2021-10-25 18:25:20', '管理员'),
